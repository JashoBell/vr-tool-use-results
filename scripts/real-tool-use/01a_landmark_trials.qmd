---
title: "Real-world - Trial-level Data - Landmark"
author: "Joshua Bell"
format:
  html:
    toc: true
...
landmark <- read_csv(here::here("data", "study_two", "landmark_full.csv")) %>%
...
landmark_fix <- read_csv(here::here("data", "study_two", "landmark_full.csv")) %>%
  select(!experiment:participant) %>%
  mutate(
