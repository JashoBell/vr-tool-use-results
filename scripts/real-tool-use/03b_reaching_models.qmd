---
title: "Real-world - Bayesian Models - Reaching"
author: "Joshua Bell"
format:
  html:
    toc: true
...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "for_osf", "tooluse_in_real", "models", "peakvelocity_ppt")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "for_osf", "tooluse_in_real", "models", "peakacceleration_ppt")
  )
...
deceleration_peaks <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "for_osf", "tooluse_in_real", "models", "peakdeceleration_ppt")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "for_osf", "tooluse_in_real", "models", "velocity_latency_ppt")
  )
...
acceleration_latencies <- update(
  ...
  sample_prior = "no",
  refresh = 0,
  file = here::here("scripts", "for_osf", "tooluse_in_real", "models", "acceleration_latency_ppt")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "for_osf", "tooluse_in_real", "models", "deceleration_latency_ppt")
  )
...
saveRDS(model_params, here::here("scripts", "for_osf", "tooluse_in_real", "tables", "model_params.rds"))
fwrite(model_params, here::here("scripts", "for_osf", "tooluse_in_real", "tables", "model_params.csv"))
