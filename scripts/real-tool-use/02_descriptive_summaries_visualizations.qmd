...
ggsave(lm_empirical, filename = here::here("scripts", "real-tool-use",  "figures", "landmark-empirical-plot.svg"), width = 15, height = 8)
saveRDS(lm_empirical, here::here("scripts", "real-tool-use",  "figures", "landmark-empirical-plot.rds"))
...
ggsave(kinematic_empirical_plots, filename = here::here("scripts", "real-tool-use", "figures", "kinematics-empirical-plot.svg"), width = 18, height = 12, bg = "transparent")
saveRDS(kinematic_empirical_plots, here::here("scripts", "real-tool-use", "figures", "kinematics-empirical-plot.rds"))
