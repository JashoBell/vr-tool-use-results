---
title: "Real-world - Bayesian Models - Landmark"
author: "Joshua Bell"
format:
  html:
    toc: true
...
landmark_time_target <- update(
  ...
  save_pars = save_pars(all = TRUE),
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "landmark_error_time_target.rds"),
...
write_csv(landmark_error_table, file = here::here("scripts", "real-tool-use", "tables", "landmark_table.csv"))
```
...
#   refresh = 0,
#   seed = 1337,
#   file = here::here("scripts", "real-tool-use", "models", "landmark_lapsefix_error_time_target.rds"),
#   file_refit = "on_change",
#   silent = TRUE
#   )
...
# write_csv(file = here::here("scripts", "real-tool-use", "tables", "landmark_table_lapsefix.csv"))
```



```{r}
model_params <- landmark_error_table %>% select(
  Parameter,
  BF,
  MAP,
  HDI_low,
...
fwrite(model_params, here::here("scripts", "real-tool-use", "tables", "landmark_model_params.csv"))

saveRDS(model_params, here::here("scripts", "real-tool-use", "tables", "landmark_model_params.rds"))
...
# fwrite(lapsefix_model_params, here::here("scripts", "real-tool-use", "tables", "landmark_lapsefix_model_params.csv"))

# saveRDS(lapsefix_model_params, here::here("scripts", "real-tool-use", "tables", "landmark_lapsefix_model_params.rds"))
```
