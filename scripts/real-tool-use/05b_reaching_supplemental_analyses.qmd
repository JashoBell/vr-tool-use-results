...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "peakvelocity_ppt_bongers")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "peakacceleration_ppt_bongers")
  )
...
deceleration_peaks <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "peakdeceleration_ppt_bongers")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "velocity_latency_ppt_bongers")
  )
...
acceleration_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "acceleration_latency_ppt_bongers")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "deceleration_latency_ppt_bongers")
  )
...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "peakvelocity_ppt_cardinali")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "peakacceleration_ppt_cardinali")
  )
...
deceleration_peaks <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "peakdeceleration_ppt_cardinali")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "velocity_latency_ppt_cardinali")
  )
...
acceleration_latencies <- update(
  ...
  sample_prior = "no",
  refresh = 0,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "acceleration_latency_ppt_cardinali")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "real-tool-use", "models", "supplementary", "deceleration_latency_ppt_cardinali")
  )
