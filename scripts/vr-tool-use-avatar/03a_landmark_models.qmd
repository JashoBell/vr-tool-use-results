---
title: "Avatar VR - Bayesian Models - Landmark"
author: "Joshua Bell"
format:
  html:
    toc: true
...
landmark_time_target <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "landmark_error_time_target.rds"),
...
write_csv(landmark_error_table, file = here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_table.csv"))
```
...
#   refresh = 0,
#   seed = 1337,
#   file = here::here("scripts", "vr-tool-use-avatar", "models", "landmark_lapsefix_error_time_target.rds"),
#   file_refit = "on_change",
#   silent = TRUE
#   )
...
# write_csv(file = here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_table_lapsefix.csv"))
```
...
fwrite(model_params, here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_model_params.csv"))

saveRDS(model_params, here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_model_params.rds"))
...
# fwrite(lapsefix_model_params, here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_lapsefix_model_params.csv"))

# saveRDS(lapsefix_model_params, here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_lapsefix_model_params.rds"))
```
