...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "peakvelocity_ppt")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "peakacceleration_ppt")
  )
...
deceleration_peaks <- update(
  ...
  refresh = 0,
  silent = FALSE,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "peakdeceleration_ppt")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "velocity_latency_ppt")
  )
...
acceleration_latency_priors <- brm(
  ...
  prior = c(
     prior_string(
      # b prior mean is empirical SD / 5, with spread of empirical SD * 2.5
       prior = paste0("normal(",
         round(log(
...
acceleration_latencies <- update(
  ...
  sample_prior = "no",
  refresh = 0,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "acceleration_latency_ppt")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "deceleration_latency_ppt")
  )
...
saveRDS(model_params, here::here("scripts", "vr-tool-use-avatar", "tables", "model_params.rds"))
fwrite(model_params, here::here("scripts", "vr-tool-use-avatar", "tables", "model_params.csv"))
```
