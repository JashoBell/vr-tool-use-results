...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "supplementary", "peakvelocity_ppt_bongers")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "supplementary", "peakacceleration_ppt_bongers")
  )
...
deceleration_peaks <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "supplementary", "peakdeceleration_ppt_bongers")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "supplementary", "velocity_latency_ppt_bongers")
  )
...
acceleration_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "supplementary", "acceleration_latency_ppt_bongers")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "vr-tool-use-avatar", "models", "supplementary", "deceleration_latency_ppt_bongers")
  )
...
fwrite(model_params, here::here("scripts", "vr-tool-use-avatar", "tables", "supplementary", "model_params_bongers.csv"))
...
saveRDS(model_table, here::here("scripts", "vr-tool-use-avatar", "tables", "supplementary", "kinematic_table_bongers.rds"))
