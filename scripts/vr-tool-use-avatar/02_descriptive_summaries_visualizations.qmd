...
knitr::opts_chunk$set(echo = FALSE, warning = FALSE, message = FALSE, fig.align = "center", fig.width = 12, fig.height = 6)
...
fwrite(change, here::here("figures", "kinematic_change.csv"), sep = ",", row.names = FALSE)
```
