...
#Model data
landmark_model <- readRDS(here::here("scripts", "vr-tool-use-avatar", "models", "landmark_error_time_target.rds"))
landmark_lapsefix_model <- readRDS(here::here("scripts", "vr-tool-use-avatar", "models","landmark_lapsefix_error_time_target.rds"))
```
...
saveRDS(landmark_posterior_expected_value_plot, here::here("scripts", "vr-tool-use-avatar", "figures", "landmark_posterior_parameter_plot.rds"))
```
...
saveRDS(landmark_posterior_predictive_plot, here::here("scripts", "vr-tool-use-avatar", "figures", "landmark-posterior-prediction-plot.rds"))
```
## Model Summary

```{r}
model_params <- readRDS(here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_model_params.rds"))
...
fwrite(draws_change, here::here("scripts", "vr-tool-use-avatar", "plot_data", "landmark_draws_change.csv"))
...
saveRDS(model_table, here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_table.rds"))
```

```{r}
# lapsefix_model_params <- readRDS(here::here("scripts", "vr-tool-use-avatar", "tables", "landmark_lapsefix_model_params.rds"))
...
# # Save the table to an RDS to be used in the manuscript
# saveRDS(lapsefix_model_table, here::here("scripts", "vr-tool-use-avatar", "tables", "lapsefix_landmark_table.rds"))
```
...
```{r}
model <- readRDS(here::here("scripts", "vr-tool-use-avatar", "models", "landmark_error_time_target.rds"))
model_lapsefix <- readRDS(here::here("scripts", "vr-tool-use-avatar", "models", "landmark_lapsefix_error_time_target.rds"))
