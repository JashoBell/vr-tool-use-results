  ...
  flextable::footnote(i = 3, j=c(1:2),
           value = as_paragraph(
             c(
               ...
               "Reported Bayes Factors represent multiplicative evidence in favor of a distalizing effect (for tool-use) over a complementary hypothesis (i.e., a one-sided test). Fractional values indicate that evidence favors the null."
               )
             ), 
           ref_symbols = c("a", "b"),
           part = "header"
