...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "peakvelocity_ppt_bongers")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "peakacceleration_ppt_bongers")
  )
...
deceleration_peaks <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "peakdeceleration_ppt_bongers")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "velocity_latency_ppt_bongers")
  )
...
acceleration_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "acceleration_latency_ppt_bongers")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "deceleration_latency_ppt_bongers")
  )
...
fwrite(model_params, here::here("scripts", "vr-tool-use", "tables", "supplementary", "model_params_bongers.csv"))
...
saveRDS(model_table, here::here("scripts", "vr-tool-use", "tables", "supplementary", "kinematic_table_bongers.rds"))
...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "peakvelocity_ppt_cardinali")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "peakacceleration_ppt_cardinali")
  )
...
deceleration_peaks <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "peakdeceleration_ppt_cardinali")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "velocity_latency_ppt_cardinali")
  )
...
acceleration_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "acceleration_latency_ppt_cardinali")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "vr-tool-use", "models", "supplementary", "deceleration_latency_ppt_cardinali")
  )
...
fwrite(model_params, here::here("scripts", "vr-tool-use", "tables", "supplementary", "model_params_cardinali.csv"))
...
saveRDS(model_table, here::here("scripts", "vr-tool-use", "tables", "supplementary", "kinematic_table_cardinali.rds"))
...
fatigue_plot
ggsave(
    filename = here::here("scripts", "vr-tool-use", "figures", "fatigue_plot.png"),
    plot = fatigue_plot,
    width = 20,
    height = 10,
    units = "in",
...
saveRDS(fatigue_plot, here::here("scripts", "vr-tool-use", "figures", "fatigue_plot.rds"))
```
