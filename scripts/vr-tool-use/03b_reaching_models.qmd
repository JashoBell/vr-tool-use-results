---
title: "VR - Bayesian Models - Reaching"
author: "Joshua Bell"
format:
  html:
    toc: true
...
knitr::opts_chunk$set(echo = TRUE, 
                      ...
                      fig.width = 12, 
                      fig.height = 8)
pkgs <- c("dplyr", "readr", "magrittr", "data.table", "here", "brms", "cmdstanr", "datawizard", "bayestestR", "flextable", "officer", "ggplot2", "tidybayes", "sessioninfo")
for(i in pkgs){
...
# Remove p1 from latencies and acceleration analysis.
...
velocity_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "for_osf", "tooluse_in_vr", "models", "peakvelocity_ppt")
  )
...
acceleration_peaks <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "for_osf", "tooluse_in_vr", "models", "peakacceleration_ppt")
  )
...
deceleration_peaks <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "for_osf", "tooluse_in_vr", "models", "peakdeceleration_ppt")
  )
...
velocity_latencies <- update(
  ...
  refresh = 0,
  seed = 1337,
  file = here::here("scripts", "for_osf", "tooluse_in_vr", "models", "velocity_latency_ppt")
  )
...
acceleration_latencies <- update(
  ...
  sample_prior = "no",
  refresh = 0,
  file = here::here("scripts", "for_osf", "tooluse_in_vr", "models", "acceleration_latency_ppt")
  )
...
deceleration_latencies <- update(
  ...
  seed = 1337,
  refresh = 0,
  file = here::here("scripts", "for_osf", "tooluse_in_vr", "models", "deceleration_latency_ppt")
  )
...
saveRDS(model_params, here::here("scripts", "for_osf", "tooluse_in_vr", "tables", "model_params.rds"))
fwrite(model_params, here::here("scripts", "for_osf", "tooluse_in_vr", "tables", "model_params.csv"))
